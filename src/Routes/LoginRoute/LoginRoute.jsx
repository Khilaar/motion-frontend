...
import { StyledDiv, StyledForm, StyledH1, StyledInput, StyledLeftMainDiv, StyledLoginHeader, StyledLoginHeaderButton, StyledMainDiv, StyledP, StyledRightMainDiv, StyledSignInButton, StyledVerificationDiv } from "../../Styles/LoginStyles";
          ...
          <StyledRightMainDiv>
            {isContinueClicked ? (
                <StyledVerificationDiv>
                  ...
                  <StyledSignInButton onClick={(e) => handleRegisterSubmit(e)}>Complete</StyledSignInButton>
                </StyledVerificationDiv>
            ) : (
              <>
                {isSubmitClicked ? (
                <StyledDiv>
                  ...
                  <StyledSignInButton onClick={handleContinue}>Continue</StyledSignInButton>
                </StyledDiv>
            ): (
              <>  
                {isRegisterClicked ? (
              ...
              <StyledInput
                ...
                />
                  ...
                  <StyledSignInButton onClick={handleSumbit}>Continue</StyledSignInButton>
            ...
            <StyledSignInButton onClick={(e) => handleLoginSubmit(e)}>
              Sign In
            </StyledSignInButton>
            </StyledDiv>
